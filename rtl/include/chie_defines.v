...
`define CHIE_REQ_FLIT_RSVDC_WIDTH                      CHIE_REQ_RSVDC_WIDTH_PARAM
`define CHIE_REQ_FLIT_RSVDC_LSB                        CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+66
`define CHIE_REQ_FLIT_RSVDC_MSB                        CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+CHIE_REQ_RSVDC_WIDTH_PARAM+65
`define CHIE_REQ_FLIT_RSVDC_RANGE                      CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+CHIE_REQ_RSVDC_WIDTH_PARAM+65:CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+66

`define CHIE_REQ_FLIT_WIDTH                            CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+CHIE_REQ_RSVDC_WIDTH_PARAM+66
`define CHIE_REQ_FLIT_LSB                              0
`define CHIE_REQ_FLIT_MSB                              CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+CHIE_REQ_RSVDC_WIDTH_PARAM+65
`define CHIE_REQ_FLIT_RANGE                            CHIE_REQ_ADDR_WIDTH_PARAM+CHIE_NID_WIDTH_PARAM*3+CHIE_REQ_RSVDC_WIDTH_PARAM+65:0
...
`define CHIE_DAT_FLIT_RSVDC_WIDTH                      CHIE_DAT_RSVDC_WIDTH_PARAM
`define CHIE_DAT_FLIT_RSVDC_LSB                        CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+51
`define CHIE_DAT_FLIT_RSVDC_MSB                        CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_RSVDC_RANGE                      CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+51

`define CHIE_DAT_FLIT_BE_WIDTH                         CHIE_BE_WIDTH_PARAM
`define CHIE_DAT_FLIT_BE_LSB                           CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51
`define CHIE_DAT_FLIT_BE_MSB                           CHIE_NID_WIDTH_PARAM*3+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_BE_RANGE                         CHIE_NID_WIDTH_PARAM*3+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51

`define CHIE_DAT_FLIT_DATA_WIDTH                       CHIE_DATA_WIDTH_PARAM
`define CHIE_DAT_FLIT_DATA_LSB                         CHIE_NID_WIDTH_PARAM*3+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51
`define CHIE_DAT_FLIT_DATA_MSB                         CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_DATA_RANGE                       CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:CHIE_NID_WIDTH_PARAM*3+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51

`define CHIE_DAT_FLIT_DATACHECK_WIDTH                  CHIE_DATACHECK_WIDTH_PARAM
`define CHIE_DAT_FLIT_DATACHECK_LSB                    CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51
`define CHIE_DAT_FLIT_DATACHECK_MSB                    CHIE_NID_WIDTH_PARAM*3+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_DATACHECK_RANGE                  CHIE_NID_WIDTH_PARAM*3+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:CHIE_NID_WIDTH_PARAM*3+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51

`define CHIE_DAT_FLIT_POISON_WIDTH                     CHIE_POISON_WIDTH_PARAM
`define CHIE_DAT_FLIT_POISON_LSB                       CHIE_NID_WIDTH_PARAM*3+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51
`define CHIE_DAT_FLIT_POISON_MSB                       CHIE_NID_WIDTH_PARAM*3+CHIE_POISON_WIDTH_PARAM+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_POISON_RANGE                     CHIE_NID_WIDTH_PARAM*3+CHIE_POISON_WIDTH_PARAM+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:CHIE_NID_WIDTH_PARAM*3+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51

`define CHIE_DAT_FLIT_WIDTH                            CHIE_NID_WIDTH_PARAM*3+CHIE_POISON_WIDTH_PARAM+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+51
`define CHIE_DAT_FLIT_LSB                              0
`define CHIE_DAT_FLIT_MSB                              CHIE_NID_WIDTH_PARAM*3+CHIE_POISON_WIDTH_PARAM+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50
`define CHIE_DAT_FLIT_RANGE                            CHIE_NID_WIDTH_PARAM*3+CHIE_POISON_WIDTH_PARAM+CHIE_DATACHECK_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM+CHIE_BE_WIDTH_PARAM+CHIE_DATA_WIDTH_PARAM/32+CHIE_DATA_WIDTH_PARAM/128+CHIE_DAT_RSVDC_WIDTH_PARAM+50:0
